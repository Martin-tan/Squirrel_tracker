# Generated by Django 2.2.7 on 2019-12-07 15:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Squirrel',
            fields=[
                ('Latitude', models.CharField(default='', help_text='Latitude', max_length=100)),
                ('Longitude', models.CharField(default='', help_text='Longitude', max_length=100)),
                ('Unique_Squirrel_ID', models.CharField(default='', help_text='Unique_Squirrel_ID', max_length=100, primary_key=True, serialize=False)),
                ('Shift', models.CharField(default='', help_text='Shift', max_length=100)),
                ('Date', models.CharField(default='', help_text='Date', max_length=100)),
